    	...
    	<div class='card mb-3'>
    		...
    		<div class='card-body'>
    			...
    			<div class='form-group' style='margin-bottom: 25px'>
    				<span class='input-group-addon'><i class='fas fa-globe'></i> Site Title</span>
                ...
                <!-- Site Description -->
                <div class='form-group' style='margin-bottom: 25px'>
                    <span class='input-group-addon'><i class='fas fa-globe'></i> Site Description</span>
                ...
                <!-- Site Keywords -->
    			<div class='form-group' style='margin-bottom: 25px'>
    				<span class='input-group-addon'><i class='fas fa-globe'></i> Site Keywords</span>
    ...
    <div class='col-lg-12 col-md-12 col-sm-12'>
    	<div class='card mb-3'>
    		...
    		<div class='card-body'>
    			...
    			<div class='form-group' style='margin-bottom: 25px'>
    				<span class='input-group-addon'><i class='fas fa-globe'></i> User Account Activation</span>
    ...
    <div class='col-lg-12 col-md-12 col-sm-12'>
    	<div class='card mb-3'>
    		...
    		<div class='card-body'>
                ...
                <!-- E-Mail Username -->
    			<div class='form-group' style='margin-bottom: 25px'>
    				<span class='input-group-addon'><i class='fas fa-globe'></i> E-Mail Username</span>
                ...
                <!-- E-Mail Password -->
    			<div class='form-group' style='margin-bottom: 25px'>
    				<span class='input-group-addon'><i class='fas fa-globe'></i> E-Mail Password</span>
                ...
                <!-- E-Mail From Name -->
    			<div class='form-group' style='margin-bottom: 25px'>
    				<span class='input-group-addon'><i class='fas fa-globe'></i> E-Mail From Name</span>
                ...
                <!-- E-Mail Host -->
                <div class='form-group' style='margin-bottom: 25px'>
                    <span class='input-group-addon'><i class='fas fa-globe'></i> E-Mail Host</span>
                ...
                <!-- E-Mail Port -->
                <div class='form-group' style='margin-bottom: 25px'>
                    <span class='input-group-addon'><i class='fas fa-globe'></i> E-Mail Host Port</span>
                ...
                <div class='form-group' style='margin-bottom: 25px'>
                    <span class='input-group-addon'><i class='fas fa-globe'></i> E-Mail SMTP Auth Type</span>
                ...
                <!-- E-Mail Site Address -->
                <div class='form-group' style='margin-bottom: 25px'>
                    <span class='input-group-addon'><i class='fas fa-globe'></i> E-Mail Site Address</span>
    ...
    <div class='col-lg-12 col-md-12 col-sm-12'>
    	<div class='card mb-3'>
    		...
    		<div class='card-body'>
                ...
                <!-- reCAPCHA Public Key -->
    			<div class='form-group' style='margin-bottom: 25px'>
    				<span class='input-group-addon'><i class='fas fa-globe'></i> reCAPCHA Public Key</span>
    			...
    			<div class='form-group' style='margin-bottom: 25px'>
    				<span class='input-group-addon'><i class='fas fa-globe'></i> reCAPCHA Private Key</span>
