	...
	<div class='panel panel-default'>
		...
		<div class='panel-body'>
			...
			<div class='input-group' style='margin-bottom: 25px'>
				<span class='input-group-addon'><i class='glyphicon glyphicon-tower'></i> Controller</span>
			...
			<!-- Method -->
			<div class='input-group' style='margin-bottom: 25px'>
				<span class='input-group-addon'><i class='glyphicon glyphicon-book'></i> Method</span>
            ...
            <!-- URL -->
			<div class='input-group' style='margin-bottom: 25px'>
				<span class='input-group-addon'><i class='glyphicon glyphicon-book'></i> URL</span>
            ...
            <!-- Arguments -->
            <div class='input-group' style='margin-bottom: 25px'>
                <span class='input-group-addon'><i class='glyphicon glyphicon-book'></i> Arguments</span>
        ...
        <!-- Group Font Weight -->
				<div class='input-group' style='margin-bottom: 25px'>
					<span class='input-group-addon'><i class='glyphicon glyphicon-book'></i> Route Enabled</span>
