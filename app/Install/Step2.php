...
function update_config($default, $new){
	$fname = ROOTDIR."app/Config.example.php";
...
if(isset($_POST['submit'])){
	...
	if(!empty($_REQUEST['SITETITLE'])){
		update_config(SITETITLE, $_REQUEST['SITETITLE']);
	}
	/** Update Site URL in Config **/
	if(!empty($_REQUEST['SITEURL'])){
		update_config(SITEURL, $_REQUEST['SITEURL']);
	}
	...
	SuccessHelper::push('You Have Successfully Updated The Config File! Please Double Check The Data!', '?install_step=2&update_config_file_refresh=true');
}
		...
		<form class="form" method="post">
			...
			<div class='panel panel-default'>
				...
				<div class='panel-body'>
					<div class="form-group">
						<label for="SITETITLE">Website Title</label><span class="label label-danger pull-right">Required</span>
						<input type="text" class="form-control" name="SITETITLE" id="SITETITLE" placeholder="<?=SITETITLE?>" value="<?php if(!empty($_REQUEST['SITETITLE'])){echo $_REQUEST['SITETITLE'];} ?>">
					</div>
					<div class="form-group">
						<label for="SITEURL">Website URL</label><span class="label label-danger pull-right">Required</span>
						<input type="text" class="form-control" name="SITEURL" id="SITEURL" placeholder="<?=SITEURL?>" value="<?php if(!empty($_REQUEST['SITEURL'])){echo $_REQUEST['SITEURL'];} ?>">
					</div>
				</div>
			</div>
			<!-- Database Settings -->
			<div class='panel panel-default'>
				...
				<div class='panel-body'>
					...
					<?php
						if($updated_config || $_GET['test_db'] == "true"){
						/** Test Database Settings **/
							echo "<div class='panel-footer'>";
							echo "<b>Database Status:</b> ";
							if($_GET['test_db'] == "true"){
			...
			<div class='panel panel-default'>
				...
				<div class='panel-body'>
					...
					<?php
						if($updated_config || $_GET['test_email'] == "true"){
							echo "<div class='panel-footer'>";
