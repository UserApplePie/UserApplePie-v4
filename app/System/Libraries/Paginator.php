    ...
    public function pageLinks($path = '?', $ext = null, $currentPage = null)
    {
      ...
      if($currentPage < 1){
        ...
        if ($lastpage > 1) {
            ...
            if ($this->page > 1) {
                $pagination.= "<li class='page-item'><a href='" . $path . "$prev" . "$ext' aria-label='Previous' class='page-link'><span aria-hidden='true'>&laquo;</span></a></li>";
            } else {
                $pagination.= "<li class='page-item disabled'><a href='#' aria-label='Previous' class='page-link'><span aria-hidden='true'>&laquo;</span></a></li>";
            }
            if ($lastpage < 7 + ($adjacents * 2)) {
                for ($counter = 1; $counter <= $lastpage; $counter++) {
                    if ($counter == $this->page) {
                        ...
                        $pagination.= "<li class='page-item'><a href='" . $path . "$counter" . "$ext' class='page-link'>$counter</a></li>";
                    }
                }
                ...
                if ($this->page < 1 + ($adjacents * 2)) {
                    ...
                    $pagination.= "<li class='page-item'><span style='border: none; background: none; padding: 8px;' class='page-link'>...</span></li>";
                    $pagination.= "<li class='page-item'><a href='" . $path . "$lpm1" . "$ext' class='page-link'>$lpm1</a></li>";
                    $pagination.= "<li class='page-item'><a href='" . $path . "$lastpage" . "$ext' class='page-link'>$lastpage</a></li>";
                } elseif ($lastpage - ($adjacents * 2) > $this->page && $this->page > ($adjacents * 2)) {
                    $pagination.= "<li class='page-item'><a href='" . $path . "1" . "$ext' class='page-link'>1</a></li>";
                    $pagination.= "<li class='page-item'><a href='" . $path . "2" . "$ext' class='page-link'>2</a></li>";
                    $pagination.= "<li class='page-item'><span style='border: none; background: none; padding: 8px;' class='page-link'>...</span></li>";
            ...
            if ($this->page < $counter - 1) {
                $pagination.= "<li class='page-item'><a href='" . $path . "$next" . "$ext' aria-label='Next' class='page-link'><span aria-hidden='true'>&raquo;</span></a></li>";
            } else {
                $pagination.= "<li class='page-item disabled'><a href='#' aria-label='Next' class='page-link'><span aria-hidden='true'>&raquo;</span></a></li>";
            }
            $pagination.= "</ul>";
            $pagination.= "</nav>\n";
